...
num_factors = [np.array([1, 0])]
den_factors = [np.array([1, 0]), np.array([1, 0.5]), np.array([1, 6, 10])]

# Ejercicio 3

# num_factors = [np.array([1, 2])]
# den_factors = [np.array([1, -4, 139])]

# Ejercicio 4
# num_factors = [np.array([1])]
# den_factors = [np.array([1, 0]), np.array([1, 3]), np.array([1, 4]), np.array([1, 8])]


# Ejercicio 5
# num_factors = [np.array([1, 3])]
# den_factors = [np.array([1, 1]), np.array([1, 2])]
