...
def resolver_modelo(modelo, solver_name="cbc", mostrar_resultado=True):
    solver = SolverFactory(solver_name)
    resultados = solver.solve(modelo, tee=mostrar_resultado)
    ...
    for t in T:
        ...
        for e in E:
            ...
            for q in Q:
                ...
                for z in Z:
                    for l in L:
                        sem_val = model.xsem[e, z, l, t, q].value
    ...
    for e in E:
        ...
        for t in T:
            for q in Q:
                ...
                for z in Z:
                    for l in L:
                        if model.xsem[e, z, l, t, q].value and model.xsem[e, z, l, t, q].value > 1e-3:
                            vacias["xsem"] += 1
